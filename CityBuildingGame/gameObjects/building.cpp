...
void Building::CreateBuildingOutline()
{
	for (int i = fromX; i < toX; ++i)
	{
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(i + 0.75f, fromY + 0.25f, position.z));
		model = glm::rotate(model, rotation.z, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, rotation.x, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, rotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.012f, 0.006f, 0.012f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(i + 0.75f, toY - 0.25f, position.z));
		model = glm::rotate(model, rotation.z, glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, rotation.x, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, rotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.012f, 0.006f, 0.012f));
	...
	for (int i = fromY; i < toY; ++i)
	{
		...
		if (i != toY - 1) {
			model = glm::mat4(1.0f);
			model = glm::translate(model, glm::vec3(fromX + 0.25f, i + 0.75f, position.z));
			model = glm::rotate(model, rotation.z, glm::vec3(0.0f, 0.0f, 1.0f));
			model = glm::rotate(model, rotation.x, glm::vec3(1.0f, 0.0f, 0.0f));
			model = glm::rotate(model, rotation.y, glm::vec3(0.0f, 1.0f, 0.0f));
			model = glm::scale(model, glm::vec3(0.012f, 0.006f, 0.012f));
